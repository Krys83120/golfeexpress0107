...
/**
 * Bulle "Nous contacter" flottante en bas à droite pour l'app Livreur
 ...
 * `source: "livreur"` permet à l'admin de savoir d'où vient chaque message
 * (voir ContactMessagesPage.tsx).
 *
 * Monté uniquement dans MainApp (App.tsx), donc jamais affichée avant
 * connexion (contrairement au Client, le Livreur n'a pas de mode invité).
 *
  ...
  async function handleSubmit() {
    ...
    try {
      await apiFetch("/api/contact", {
        method: "POST",
        body: { name, email, type, subject, message, source: "livreur" },
      });
      setStatus("success");
    } catch (err) {
      setStatus("error");
