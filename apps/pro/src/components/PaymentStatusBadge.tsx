 ...
 * statut de traitement existant (OrderStatusBadge), jamais à sa place : les
 * deux répondent à des questions différentes ("où en est la
 * préparation/livraison ?" vs "est-ce payé ?"). Voir paymentStatusLabels.ts.
 */
