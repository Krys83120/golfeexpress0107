...
export function SplashLoader({ ready, onFinished, imageUrl }: SplashLoaderProps) {
  ...
  // WATCHDOG_MS, de façon totalement transparente pour l'utilisateur.
  // Un seul rechargement autorisé par minute glissante (sessionStorage) pour
  ...
  // plutôt que de faire disparaître ce contenu au préalable (transition CSS
  // déclenchée sur 2 frames pour partir bien de hors-champ), ce qui donnait
