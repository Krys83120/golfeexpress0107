 ...
 * raisonnement : fausse progression plafonnée à 92% tant que le vrai
 * chargement (`ready`) n'est pas terminé, puis complétion rapide jusqu'à
 * 100% avant de céder la place au vrai contenu.
 */
