...
import { renameProductCategory } from "@/services/productsApi";
...
export function CategoryManagerModal({ categories, onClose, onRenamed }: CategoryManagerModalProps) {
    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/40 p-4">
      <div className="w-full max-w-md rounded bg-white p-6 shadow-xl">
        <div className="mb-4 flex items-center justify-between">
          <h2 className="font-heading text-lg font-bold text-nuit">Gérer mes catégories</h2>
        ...
        <p className="mb-4 text-xs text-gris">
          Renommez une catégorie pour la réorganiser — tous les produits qui l'utilisent sont mis à jour
          automatiquement. Utiliser le nom d'une catégorie existante fusionne les deux.
        </p>
