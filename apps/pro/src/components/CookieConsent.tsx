...
// vitrine (apps/www), cette app n'a pas de page équivalente — on renvoie
// donc vers l'URL absolue plutôt que d'en dupliquer une ici.
 ...
 * équivalent d'apps/www (voir CookieConsent.tsx de ce dossier) pour l'espace
 * Pro. Affiché tant que l'utilisateur n'a pas fait de choix, et rouvrable à
 * tout moment via openCookiePreferences().
 */
        ...
        {!customizing ? (
          <>
            <p className="text-sm leading-relaxed text-nuit">
              🍪 Nous utilisons des cookies essentiels au bon fonctionnement de l'espace Pro, et — uniquement avec
              votre accord — des cookies de mesure d'audience pour comprendre comment il est utilisé. Vous pouvez
              changer d'avis à tout moment depuis « Gérer les cookies ».{" "}
              <a
                href={PRIVACY_URL}
                target="_blank"
                rel="noreferrer"
                className="font-semibold text-golfe-green underline"
              >
                En savoir plus
              </a>
            </p>
            ...
            <div className="mt-4 space-y-3">
              <div className="flex items-start justify-between gap-4 rounded-xl bg-gris-light p-4">
                <div>
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-gris">
                    Nécessaires au fonctionnement de l'espace Pro (connexion, mémorisation de votre choix de
              ...
              <div className="flex items-start justify-between gap-4 rounded-xl bg-gris-light p-4">
                <div>
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-gris">
                    Nous aide à comprendre l'usage de l'espace Pro de façon anonymisée. Jamais utilisé à des fins
