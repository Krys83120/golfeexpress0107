 ...
 * et annulée en rouge".
 *
 * En pratique, le Pro ne voit jamais paymentStatus=PENDING/AUTHORIZED sur
 * une commande visible chez lui : les commandes PENDING (pas encore
 * payées) sont désormais exclues côté API (voir GET /api/orders,
 * excludePendingForPro) -- ce fichier reste identique à sa version Admin
 * par cohérence et pour couvrir les cas limites (ex: commande annulée par
 * le client avant paiement, qui redevient visible en statut CANCELLED).
 *
