 ...
 * RIDER_ASSIGNED) : le Pro (ou un employé, voir requireProOrEmployee() dans
 * middleware/auth.ts) doit pouvoir signaler "c'est prêt, tu peux venir
 * chercher" sans repasser par une transition de statut qui n'a plus de sens
 * dans ce cas (RIDER_ASSIGNED -> READY casserait la machine à états, qui
 * traite RIDER_ASSIGNED comme postérieur à READY dans le flux "classique"
 * sans recherche anticipée).
 *
